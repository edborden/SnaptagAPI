ActiveRecord::Schema.define(version: 20141218005706) do
  ...
  add_index "hunts", ["stalker_id"], name: "index_hunts_on_stalker_id", using: :btree
  add_index "hunts", ["target_id"], name: "index_hunts_on_target_id", using: :btree
  ...
  add_index "users", ["activationqueue_id"], name: "index_users_on_activationqueue_id", using: :btree
  ...
  add_index "webs", ["giver_id"], name: "index_webs_on_giver_id", using: :btree
  add_index "webs", ["receiver_id"], name: "index_webs_on_receiver_id", using: :btree
